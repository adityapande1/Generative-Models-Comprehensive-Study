...
data_args.add_argument('--train_data_path', type=str, default='./data/helix_3D_train.npy', help='Path to training data numpy file')
data_args.add_argument('--test_data_path', type=str, default='./data/helix_3D_test.npy', help='Path to test data numpy file')
