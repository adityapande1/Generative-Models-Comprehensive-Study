...
training_args.add_argument('--train_data_path', type=str, default='./data/helix_3D_train.npy', help='Path to training data numpy file')
...
run_name = f'n_dim={n_dim},n_steps={n_steps},lbeta={lbeta:.3e},ubeta={ubeta:.3e},batch_size={batch_size},n_epochs={n_epochs},ns6'
